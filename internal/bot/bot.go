	...
	if !hasAnyAchievement {
		if caloriesToAdd > 0 {
			...
			if b.aiClient != nil {
				...
				// Единое сообщение для дополнительной тренировки (объединяем приписку и мудрость) - БЕЗ общих фраз
...
func (b *Bot) getUnifiedTrainingPrompt(streakDays, totalCalories, totalCups int, wasOnSickLeave bool) string {
	...
	// Базовые стили единых промптов (объединяют приписку и мудрость) - БЕЗ общих фраз про "помни", "дух", "волю"
	prompts := []string{
...
func (b *Bot) shouldDetectChatTypeAsWriting(text string, chatID int64) bool {
	...
	writingKeywords := []string{
		...
		"текст", "текста", "текстом", "тексты", "рассказ", "рассказа", "роман", "романа", "романом", "повесть", "повести",
		"стих", "стихи", "стихов", "поэма", "поэмы", "поэмы", "стихотворение", "стихотворения",
		"автор", "автора", "автором", "авторы", "сюжет", "сюжета", "сюжетом", "персонаж", "персонажи", "персонажа", "персонажей",
		"герой", "герои", "героя", "героев", "глава", "глав", "главой", "страниц", "страница", "страницы",
		"сочинение", "сочинения", "сочинять", "сочинял", "сочиняла", "рукопись", "рукописи", "издательство", "издательства",
		"публикация", "публикации", "публиковать", "публиковал", "публиковала", "публиковал",
		"литератур", "проза", "проз", "прозой", "драматург", "драматурги", "поэт", "поэтесс", "поэзия", "поэзией",
		"книг", "книга", "книгу", "книгой", "книги", "книж", "книжный", "книжного",
		"газет", "газета", "газету", "газете", "газетой", "отрывок", "отрывка", "отрывком", "отрывки",
		"дописала", "дописал", "дописывал", "дописывала", "дописываю", "дописывать",
		"сцен", "сцена", "сцены", "сценой", "сцену",
		"кампани", "кампания", "кампании", "кампанию",
		"клуб", "клуба", "клубе", "клубу", "клубом", "писательский клуб",
		"клиент", "клиента", "клиенту", "клиентом", "клиенты",
		"обдумывал", "обдумывала", "обдумывала", "обдумываю", "обдумывать", "обдумываю",
		"перечитывал", "перечитывала", "перечитывала", "перечитываю", "перечитывать",
		"застопорился", "застопорилась", "застопорилась", "застопор",
		"нравится", "не нравится", "нравятся",
		"диалог", "диалога", "диалоги", "монолог", "монолога", "монологи",
