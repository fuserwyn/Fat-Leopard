...
- Если в контексте указан пол пользователя (gender: male/female), используй правильные формы: для female используй "начала", "молодец" (женский род), для male — "начал", "молодец" (мужской род). Если пол не указан, используй нейтральные формы
